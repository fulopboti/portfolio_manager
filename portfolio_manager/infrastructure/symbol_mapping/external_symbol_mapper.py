...
class ExternalSymbolMapper(SymbolMappingService):
    ...
    def _parse_symbol_mapping(self, data: dict) -> Optional[SymbolMapping]:
    ...
    def _parse_exchange_info(self, data: dict) -> Optional[ExchangeInfo]:
    ...
    def _parse_provider_info(self, data: dict) -> Optional[ProviderInfo]:

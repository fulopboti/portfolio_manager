...
class DuckDBSchemaManager(SchemaManager):
    ...
    async def create_schema(self) -> None:
        ...
        try:
            logger.info("Creating StockApp database schema...")
            ...
            # Set schema version
            await self.set_schema_version(StockAppSchema.SCHEMA_VERSION)
    ...
    async def drop_schema(self) -> None:
        ...
        try:
            logger.info("Dropping StockApp database schema...")
    ...
    async def set_schema_version(self, version: str) -> None:
        ...
        try:
            ...
            if not await self.inspector.table_exists("schema_migrations"):
                migrations_table = StockAppSchema.get_schema_migrations_table()
    ...
    async def validate_schema(self) -> Dict[str, any]:
        ...
        """
        try:
            expected_tables = StockAppSchema.get_all_tables()

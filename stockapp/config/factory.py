...
from .schema import (
    StockAppConfig, validate_config, DatabaseConfig, EventSystemConfig,
...
class ConfiguredComponentFactory:
    ...
    def __init__(self, config_manager=None):
        ...
        self._validated_config: Optional[StockAppConfig] = None
    ...
    @property
    def validated_config(self) -> StockAppConfig:
